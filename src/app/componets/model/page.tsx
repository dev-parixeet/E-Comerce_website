...
type Props = { onClose: () => void; ondelete: () => void; }

const Modelcom = ({ onClose, ondelete }: any) => {
    return (
        <>
            <link
                    ...
                    <div>
                        <div className="text-center p-5 flex-auto justify-center">
                            ...
                            <p className="text-sm text-red-500 px-8">
                                Do you really want to delete your product....? This product cannot be
                                undone
                            </p>
                        </div>
                        ...
                        <div className="p-3  mt-2 text-center space-x-4 md:block">
                            ...
                            <button onClick={ondelete} className="mb-2 md:mb-0 bg-red-500 border border-red-500 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-red-600">
                                Delete
                            </button>
                        </div>
                    </div>
